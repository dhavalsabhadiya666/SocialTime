...
class ApplyJobListScreen extends StatefulWidget {
  ...
  @override
  _ApplyJobListScreenState createState() => _ApplyJobListScreenState();
}

class _ApplyJobListScreenState extends StateMVC<ApplyJobListScreen> {
  AddApplicantController? _con;

  _ApplyJobListScreenState() : super(AddApplicantController()) {
    ...
    return Scaffold(
        ...
        actions: [
          GestureDetector(
            ...
            child: const Padding(
              ...
              child: Icon(Icons.delete,color: AppConstants.clrWhite,),
            ),
          ),
      ...
      bottomSheet:   Container(
        ...
        child: CustomButton(margin: EdgeInsets.symmetric(horizontal: 15,vertical: 15),
            ...
            onTap: () {
              chargeTokenWarningDialog(context);
            },
