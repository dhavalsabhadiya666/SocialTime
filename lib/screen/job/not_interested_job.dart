...
class NotInterestedJobScreen extends StatefulWidget {
  const NotInterestedJobScreen({Key? key}) : super(key: key);

  @override
  _NotInterestedJobScreenState createState() => _NotInterestedJobScreenState();
}

class _NotInterestedJobScreenState extends StateMVC<NotInterestedJobScreen> {
  AddApplicantController? _con;

  _NotInterestedJobScreenState() : super(AddApplicantController()) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _con!.applicantJobListDataModel == null ||
            ...
            itemBuilder: (context, index){
              return  GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      _con!.applicantJobListDataModel![index].media != null
                          ? Container(
                        height: 157,
                        decoration: _con!.applicantJobListDataModel![index].media!
                            ...
                            image: DecorationImage(
                                image: NetworkImage(_con!.applicantJobListDataModel![index]
                                    .media
                                    .toString()),
                                fit: BoxFit.cover))
                            ...
                            _con!.applicantJobListDataModel![index].thumbnail !=
                                '' ||
                            _con!.applicantJobListDataModel![index]
                                .thumbnail
                                .toString() !=
                            ...
                            color: AppConstants.clrBlack26,
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(image: NetworkImage(_con!.applicantJobListDataModel![index].thumbnail.toString()), fit: BoxFit.cover))
                            : const BoxDecoration(),
                      ) : Container(),
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text(
                                    _con!.applicantJobListDataModel![index].title.toString(),
                                ...
                                Text(_con!.applicantJobListDataModel![index].location.toString(),
                                    style: const TextStyle(
                            ...
                            Text( DateFormat('dd MMM, yyyy')
                                .format(_con!.applicantJobListDataModel![index]
                                .createdAt!)
                                .toString(),
                                style: const TextStyle(
                                    color: AppConstants.clrLightGreyTxt,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Image.asset(AppConstants.checkCircle,height: 25,width: 25)
      ...
      bottomSheet:   Container(
        ...
        child: CustomButton(margin: EdgeInsets.symmetric(horizontal: 15,vertical: 15),
            height: 50,
