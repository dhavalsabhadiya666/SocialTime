...
class RecommendJobScreen extends StatefulWidget {
  @override
  _RecommendJobScreenState createState() => _RecommendJobScreenState();
}

class _RecommendJobScreenState extends State<RecommendJobScreen> {
  @override
