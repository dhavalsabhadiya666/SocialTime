...
class ApplicationRecommendDetails extends StatefulWidget {
  const ApplicationRecommendDetails({Key? key}) : super(key: key);

  @override
  _ApplicationRecommendDetailsState createState() => _ApplicationRecommendDetailsState();
}

class _ApplicationRecommendDetailsState extends State<ApplicationRecommendDetails> {
  @override
  void initState() {
    super.initState();
  }
