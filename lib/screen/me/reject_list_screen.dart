...
class RejectListScreen extends StatefulWidget {
  @override
  _RejectListScreenState createState() => _RejectListScreenState();
}

class _RejectListScreenState extends State<RejectListScreen> {
  @override
        ...
        child: Row(
          ...
          children: [
            ...
            //  padding: const EdgeInsets.symmetric(vertical: 8),
              ...
              onTap: () {
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ShortListScreen()));
              },
           ...
           //   padding: const EdgeInsets.symmetric(vertical: 8),
              ...
              width: AppConstants.displayWidth(context) * 0.45,
              onTap: () {
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ConnectListScreen()));
              },
              textColor: AppConstants.clrWhite,
              radius: 10,
